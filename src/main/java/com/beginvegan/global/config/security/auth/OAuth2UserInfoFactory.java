package com.beginvegan.global.config.security.auth;

import java.util.Map;

import com.beginvegan.global.DefaultAssert;
import com.beginvegan.global.config.security.auth.company.Facebook;
import com.beginvegan.global.config.security.auth.company.Github;
import com.beginvegan.global.config.security.auth.company.Google;
import com.beginvegan.global.config.security.auth.company.Kakao;
import com.beginvegan.global.config.security.auth.company.Naver;
