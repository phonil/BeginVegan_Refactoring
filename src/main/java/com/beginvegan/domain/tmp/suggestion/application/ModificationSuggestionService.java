package com.beginvegan.domain.tmp.suggestion.application;
...
import com.beginvegan.domain.tmp.suggestion.domain.child.repository.ModificationSuggestionRepository;
import com.beginvegan.domain.tmp.suggestion.domain.parent.Inspection;
import com.beginvegan.domain.tmp.suggestion.domain.parent.SuggestionType;
import com.beginvegan.domain.tmp.suggestion.dto.request.ModifyReq;
